export const AboutMeLang = {
	['ru']: {
		...
		description:
			'Я Frontend разработчик, ориентированный на результат при создании SPA приложений с использованием React (JS/TS), Redux. Хотелось бы найти проектную работу на постоянной основе в компании с современным подходом к разработке и сплоченной командой.',
		mood: 'Хобби',
